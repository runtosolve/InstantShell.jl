...
function calculate_total_potential_energy(ac, bc, μc, δc, tc, δoc, σxc, σyc, τxyc)
...
fcr = π^2 * Ec / (12 * (1-μc^2))*(tc/bc)^2

σxc = range(0.0, -130.0, 10) #N/mm^2
